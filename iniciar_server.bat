...
start DayZServer_x64.exe -config=serverDZ.cfg -port=2302 -profiles=ServerProfile "-mod=@CF;@Dabs Framework;@AC-Mod-Pack;@AdvancedBanking;@Airdrop-Upgraded;@AntiContainerStacking;@ArrakisTraderSigns;@BaseBuildingPlus;@Basic Territories;@BasicSpawnSelect;@BBPItemPack;@Better Inspect;@BuilderItems;@BuildEverywhere;@CannabisPlus;@CARs;@Code Lock;@Collectable Items;@Creatures Of The Night;@DayZ Editor Loader;@DNA Keycards;@DrugsPLUS;@Erapulsar_Zombies;@FlipTransport;@FS(FIDOvSTALKER);@Forward Operator Gear;@Garage;@gebsfish;@LIGHTS;@LoftDModGR Clothes Pack;@MagazineLoading;@MMG - Mightys Military Gear;@MMG Base Storage;@MuchCarKey;@MuchStuffPack;@No Glove Or Shoe Damage;@PokemonAlbum;@PristineRepair;@PvZmoD_CustomisableZombies;@Quadlock's Pack;@RedFalcon Flight System Heliz;@DayZ-Expansion-Core;@DayZ-Expansion-Navigation;@DayZ-Expansion-Book;@DayZ-Expansion-Groups;@SNAFU Weapons;@Trader;@TraderFixesAndFeatures;@VPPAdminTools;@BetterVendingMachines;@Radio;@Crocos Quadbike;@BulletStacksPlusPlus;@DayZ-Dog;@WindstridesClothingPack;@RaG_Liquid_Framework;@RaG_BeeHive;@CBD Halo Armour;@Solar Panel Power System;@RevGuns;@StaticBaseEFWeb;@SpawnerBubaku;@Velha_Guarda_PVE_Chernarus;@PVEZ Reloaded;@Z_Predator;@Z_Alien" -cpuCount=4 -dologs -adminlog -netlog -freezecheck
